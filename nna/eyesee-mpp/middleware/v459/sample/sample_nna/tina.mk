# 额外添加的
# export STAGING_DIR=/home/myuan/v831/v831-ncnn-main/toolchain-sunxi-musl/toolchain/bin/
CWD = $(shell pwd)
TOOLCHAIN_PATH = $(CWD)/../../../../../../toolchain-sunxi-musl/toolchain/bin
CC := $(TOOLCHAIN_PATH)/arm-openwrt-linux-muslgnueabi-gcc
CXX := $(TOOLCHAIN_PATH)/arm-openwrt-linux-muslgnueabi-g++
PUBLIC_PATH := $(CWD)/../../../../system/public
MPPCFG_VDEC := N
